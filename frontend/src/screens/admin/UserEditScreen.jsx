           ...
           <Form onSubmit={submitHandler}>
            ...
            <Form.Group controlId='email' className='mb-3'>
              <Form.Label>Email Address</Form.Label>
                <Form.Control type='email' placeholder='Enter user email' value={email} onChange={(e) => setEmail(e.target.value)}></Form.Control>
            </Form.Group>
            ...
            <Button type='submit' variant='primary' className='mb-3' disabled={loadingUpdate}>
              {loadingUpdate ? 'Applying the Changes' : 'Update'}
            </Button>
          </Form>
        )}
      </FormContainer>
